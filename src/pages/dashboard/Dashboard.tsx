...
export const Dashboard = () => {
  const { username, level, courses, coursesLoading, toggleJoin, isJoin, courseCode, setCourseCode } = useDashboardPage()

  return (
    <div>
      <PageContainer>
        <StatusHeader username={username} level={level} courses={courses} coursesLoading={coursesLoading} />
        <Courses coursesLoading={coursesLoading} courses={courses} toggleJoin={toggleJoin} />
      </PageContainer>
